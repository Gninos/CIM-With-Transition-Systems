/* Created Thu Oct 17 02:22:19 2019 by frac version 2.5.0 */
...
/* provider */
char *source_info[3] = {"frac","2.5.0","Thu Oct 17 02:22:19 2019"};
...
char *transtable[14] = {"intersection_1_t0","intersection_1_t1","intersection_1_t2","intersection_1_t3","intersection_1_t4","intersection_1_t5","intersection_1_t6","intersection_1_t7","intersection_1_t8","intersection_1_t9","intersection_1_t10","intersection_1_t11","intersection_1_t12","intersection_1_t13"};
...
bool pre_7 (key s) {
  ...
  intersection_1_vr=fcr_road(intersection_1_vva); 
  if (!((v->intersection_1_vt < 3))) return 0;
  if (!((intersection_1_vy < 3))) return 0;
  if (!((v->intersection_1_va.at[intersection_1_vy].at[intersection_1_vx] == intersection_1_vva))) return 0;
  if (!((v->intersection_1_va.at[IADD(intersection_1_vy,1,0,5)].at[intersection_1_vx] == 0))) return 0;
  if (!((v->intersection_1_va.at[IADD(intersection_1_vy,2,0,5)].at[intersection_1_vx] == 0))) return 0;
  if (!((intersection_1_vr == 1))) return 0;
  return 1;
 error: return 0;
}
...
bool pre_10 (key s) {
  ...
  intersection_1_vr=fcr_road(intersection_1_vva); 
  if (!((v->intersection_1_vt < 3))) return 0;
  if (!((intersection_1_vx < 3))) return 0;
  if (!((v->intersection_1_va.at[intersection_1_vy].at[intersection_1_vx] == intersection_1_vva))) return 0;
  if (!((v->intersection_1_va.at[intersection_1_vy].at[IADD(intersection_1_vx,1,0,5)] == 0))) return 0;
  if (!((v->intersection_1_va.at[intersection_1_vy].at[IADD(intersection_1_vx,2,0,5)] == 0))) return 0;
  if (!((intersection_1_vr == 2))) return 0;
  return 1;
 error: return 0;
}
...
key act_7 (key s) {
  ...
  intersection_1_vy=intersection_1_vpos.at[1]; 
  intersection_1_vr=fcr_road(intersection_1_vva); 
  new.intersection_1_va.at[IADD(intersection_1_vy,2,0,5)].at[intersection_1_vx]=intersection_1_vva; 
  new.intersection_1_va.at[intersection_1_vy].at[intersection_1_vx]=0; 
  new.intersection_1_vpy.at[new.intersection_1_vt]=IADD(intersection_1_vy,2,0,5); 
  new.intersection_1_vt=IADD(new.intersection_1_vt,1,0,3); 
  return store(&new);
 error: return s;
}
...
key act_10 (key s) {
  ...
  intersection_1_vy=intersection_1_vpos.at[1]; 
  intersection_1_vr=fcr_road(intersection_1_vva); 
  new.intersection_1_va.at[intersection_1_vy].at[IADD(intersection_1_vx,2,0,5)]=intersection_1_vva; 
  new.intersection_1_va.at[intersection_1_vy].at[intersection_1_vx]=0; 
  new.intersection_1_vpx.at[new.intersection_1_vt]=IADD(intersection_1_vx,2,0,5); 
  new.intersection_1_vt=IADD(new.intersection_1_vt,1,0,3); 
  return store(&new);
 error: return s;
}
