...
with open ("C:\\Users\\Acer\\Google Drive\\UFSC\\Dissertação\\Fiacre Exemplos\\exemplos atuais\\Intersection8x8 - R 4 CAVs - D - 2\\info.txt", 'rt') as info:    
    for t in info: 
...
reach_file = open("C:\\Users\\Acer\\Google Drive\\UFSC\\Dissertação\\Fiacre Exemplos\\exemplos atuais\\Intersection8x8 - R 4 CAVs - D - 2\\reach_graph.txt", 'r')
