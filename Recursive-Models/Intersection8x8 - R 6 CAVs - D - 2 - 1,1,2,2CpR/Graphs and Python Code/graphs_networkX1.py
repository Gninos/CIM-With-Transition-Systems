...
with open ("C:\\Users\\Acer\\Google Drive\\UFSC\\Dissertação\\Fiacre Exemplos\\exemplos atuais\\Intersection2 - 4 CAVs R - 2 - D - 1CR\\info.txt", 'rt') as info:    
    for t in info: 
...
reach_file = open("C:\\Users\\Acer\\Google Drive\\UFSC\\Dissertação\\Fiacre Exemplos\\exemplos atuais\\Intersection2 - 4 CAVs R - 2 - D - 1CR\\reach_graph.txt", 'r')
