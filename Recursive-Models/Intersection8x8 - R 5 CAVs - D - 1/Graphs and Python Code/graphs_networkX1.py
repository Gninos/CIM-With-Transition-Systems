...
with open ("C:\\Users\\Acer\\Google Drive\\UFSC\\Dissertação\\Fiacre Exemplos\\exemplos atuais\\Intersection8x8 - R 5 CAVs - D - 1\\info.txt", 'rt') as info:    
    for t in info: 
...
reach_file = open("C:\\Users\\Acer\\Google Drive\\UFSC\\Dissertação\\Fiacre Exemplos\\exemplos atuais\\Intersection8x8 - R 5 CAVs - D - 1\\reach_graph.txt", 'r')
