/* Created Sun Jun 06 19:06:42 2021 by frac version 2.5.0 */
...
/* provider */
char *source_info[3] = {"frac","2.5.0","Sun Jun 06 19:06:42 2021"};
...
bool pre_9 (key s) {
  ...
  intersection_1_vva=fcr_cav(intersection_1_vtaux); 
  intersection_1_vr=fcr_road(intersection_1_vva); 
  if (!((((intersection_1_vx < 4) || ((intersection_1_vx == 4) && (((intersection_1_vy == 3) || (intersection_1_vy == 4)) || (intersection_1_vy == 5)))) || ((intersection_1_vx == 5) && ((intersection_1_vy == 4) || (intersection_1_vy == 5)))))) return 0;
  if (!((v->intersection_1_va.at[intersection_1_vy].at[intersection_1_vx] == intersection_1_vva))) return 0;
...
bool pre_10 (key s) {
  ...
  intersection_1_vva=fcr_cav(intersection_1_vtaux); 
  intersection_1_vr=fcr_road(intersection_1_vva); 
  if (!(((((intersection_1_vx < 4) && (intersection_1_vy > 2)) || ((intersection_1_vx == 4) && ((intersection_1_vy == 4) || (intersection_1_vy == 5)))) || ((intersection_1_vx == 5) && (intersection_1_vy == 4))))) return 0;
  if (!((v->intersection_1_va.at[intersection_1_vy].at[intersection_1_vx] == intersection_1_vva))) return 0;
...
bool pre_11 (key s) {
  ...
  intersection_1_vva=fcr_cav(intersection_1_vtaux); 
  intersection_1_vr=fcr_road(intersection_1_vva); 
  if (!((((intersection_1_vx < 5) && (intersection_1_vy < 5)) || ((intersection_1_vx == 5) && ((intersection_1_vy == 3) || (intersection_1_vy == 4)))))) return 0;
  if (!((v->intersection_1_va.at[intersection_1_vy].at[intersection_1_vx] == intersection_1_vva))) return 0;
  if (!((v->intersection_1_va.at[IADD(intersection_1_vy,1,0,7)].at[IADD(intersection_1_vx,1,0,7)] == 0))) return 0;
  if (!((intersection_1_vr == 2))) return 0;
  return 1;
...
bool pre_16 (key s) {
  ...
  intersection_1_vva=fcr_cav(intersection_1_vtaux); 
  intersection_1_vr=fcr_road(intersection_1_vva); 
  if (!((((intersection_1_vx > 3) || ((intersection_1_vx == 3) && (((intersection_1_vy == 2) || (intersection_1_vy == 3)) || (intersection_1_vy == 4)))) || ((intersection_1_vx == 2) && ((intersection_1_vy == 2) || (intersection_1_vy == 3)))))) return 0;
  if (!((v->intersection_1_va.at[intersection_1_vy].at[intersection_1_vx] == intersection_1_vva))) return 0;
...
bool pre_17 (key s) {
  ...
  intersection_1_vva=fcr_cav(intersection_1_vtaux); 
  intersection_1_vr=fcr_road(intersection_1_vva); 
  if (!((((intersection_1_vx > 2) && (intersection_1_vy > 2)) || ((intersection_1_vx == 2) && ((intersection_1_vy == 3) || (intersection_1_vy == 4)))))) return 0;
  if (!((v->intersection_1_va.at[intersection_1_vy].at[intersection_1_vx] == intersection_1_vva))) return 0;
  if (!((v->intersection_1_va.at[ISUB(intersection_1_vy,1,0,7)].at[ISUB(intersection_1_vx,1,0,7)] == 0))) return 0;
  if (!((intersection_1_vr == 4))) return 0;
  return 1;
...
bool pre_18 (key s) {
  ...
  intersection_1_vva=fcr_cav(intersection_1_vtaux); 
  intersection_1_vr=fcr_road(intersection_1_vva); 
  if (!(((((intersection_1_vx > 3) && (intersection_1_vy < 5)) || ((intersection_1_vx == 3) && ((intersection_1_vy == 2) || (intersection_1_vy == 3)))) || ((intersection_1_vx == 2) && (intersection_1_vy == 2))))) return 0;
  if (!((v->intersection_1_va.at[intersection_1_vy].at[intersection_1_vx] == intersection_1_vva))) return 0;
  if (!((v->intersection_1_va.at[IADD(intersection_1_vy,1,0,7)].at[ISUB(intersection_1_vx,1,0,7)] == 0))) return 0;
  if (!((intersection_1_vr == 4))) return 0;
  return 1;
