...
plt.arrow(2.5, 1.5, 0.0, 1.5, head_width=0.2, head_length=0.4, fc= 'blue', ec= 'blue', width=0.08)
plt.arrow(2.5, 2.5, 0.5, 0.0, head_width=0.2, head_length=0.4, fc= 'blue', ec= 'blue', width=0.08)
plt.arrow(1.5, 3.5, 1.5, 0.0, head_width=0.2, head_length=0.4, fc= 'red', ec= 'red', width=0.08)
plt.arrow(4.5, 5.5, 0.0, -1.5, head_width=0.2, head_length=0.4, fc= 'olive', ec= 'olive', width=0.08)
plt.arrow(4.5, 4.5, 0.5, 0.0, head_width=0.2, head_length=0.4, fc= 'olive', ec= 'olive', width=0.08)
