/* Created Sun Jun 06 16:55:04 2021 by frac version 2.5.0 */
...
/* provider */
char *source_info[3] = {"frac","2.5.0","Sun Jun 06 16:55:04 2021"};
...
bool pre_9 (key s) {
  ...
  intersection_1_vr=fcr_road(intersection_1_vva); 
  intersection_1_vcd=fcr_des(intersection_1_vtaux); 
  if (!((intersection_1_vy == 0))) return 0;
  if (!((v->intersection_1_va.at[intersection_1_vy].at[intersection_1_vx] == intersection_1_vva))) return 0;
  if (!((!(v->intersection_1_va.at[IADD(intersection_1_vy,1,0,7)].at[intersection_1_vx] == 0)))) return 0;
  if (!((intersection_1_vr == 1))) return 0;
  if (!((intersection_1_vcd == 4))) return 0;
...
bool pre_10 (key s) {
  ...
  intersection_1_vr=fcr_road(intersection_1_vva); 
  intersection_1_vcd=fcr_des(intersection_1_vtaux); 
  if (!((((intersection_1_vy == 1) && ((intersection_1_vx == 2) || (intersection_1_vx == 3))) || ((intersection_1_vy == 2) && (intersection_1_vx == 3))))) return 0;
  if (!((v->intersection_1_va.at[intersection_1_vy].at[intersection_1_vx] == intersection_1_vva))) return 0;
...
bool pre_11 (key s) {
  ...
  intersection_1_vcd=fcr_des(intersection_1_vtaux); 
  if (!(((intersection_1_vx == 4) || (intersection_1_vx == 5)))) return 0;
  if (!(((intersection_1_vy == 2) || (intersection_1_vy == 3)))) return 0;
  if (!((v->intersection_1_va.at[intersection_1_vy].at[intersection_1_vx] == intersection_1_vva))) return 0;
...
bool pre_14 (key s) {
  ...
  if (!((intersection_1_vr == 1))) return 0;
  if (!((intersection_1_vcd == 4))) return 0;
  if (!(((v->intersection_1_vlm.at[intersection_1_vtaux] == 2) || (v->intersection_1_vlm.at[intersection_1_vtaux] == 3)))) return 0;
  return 1;
 error: return 0;
}
...
bool pre_21 (key s) {
  ...
  intersection_1_vr=fcr_road(intersection_1_vva); 
  intersection_1_vcd=fcr_des(intersection_1_vtaux); 
  if (!((((intersection_1_vy == 6) && ((intersection_1_vx == 4) || (intersection_1_vx == 5))) || ((intersection_1_vy == 5) && (intersection_1_vx == 5))))) return 0;
  if (!((v->intersection_1_va.at[intersection_1_vy].at[intersection_1_vx] == intersection_1_vva))) return 0;
